...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2FydW1haWRvIiwiYSI6ImNrcm4yZWl0cDFwOTIydnJ2Ymk1MDFyZDMifQ.K-ygLRCoFAo3hl9GlBas0g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11',
    scrollZoom: false //   center: [-118.907, 34.0676],
    //   zoom: 4,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Errror when logging out, please try again sometime later');
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"updateUser.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:9300/api/v1/users/updatePassword' : 'http://127.0.0.1:9300/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Data updated successifully');
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js":[function(require,module,exports) {
"use strict";
...
var stripe = (0, _stripeJs.loadStripe)('pk_test_51JmZ8aG0xyz1wvCDS67eHlrUhaJ7us5mCleQW1C2uotLflfmGHsEwKVUO3Fj3ojV2c0TuuTToYCIYUX2tXleVUmo00h6kM17Za');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:9300/api/v1/bookings/checkout-session/".concat(tourId));
...
},{"axios":"../../node_modules/axios/index.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/dist/stripe.esm.js","./alert.js":"alert.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (updateUserPassword) updateUserPassword.addEventListener('submit', /*#__PURE__*/function () {
